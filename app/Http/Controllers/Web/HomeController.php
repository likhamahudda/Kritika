...
class HomeController extends Controller
{
    ...
    public function aboutUs()
    {
        ...
        return view('web.pages.about_us', $result);
    }
    ...
    {
        $result = ['title' => "FAQ's"];
        return view('web.pages.privacy_policy', $result);
    }


    public function termsConditions()
    {
        $result = ['title' => "Terms and condition"];
        return view('web.pages.terms_conditions', $result);
    }
