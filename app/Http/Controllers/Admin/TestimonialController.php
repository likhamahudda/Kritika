...
class TestimonialController extends Controller
{
    ...
    public function form($id = null)
    {
        ...
        $result = ['title' => ucwords($type .'Occupations' ), 'page' => $this->page, 'data' => $data];
    ...
    public function manage(Request $request)
    {
        ...
        if ($data->save()) {
                return response()->json(['status' => true, 'message' => 'Occupations has been '.$type.' succesfully']);
        } else {
            return response()->json(['status' => false,  'message' => 'Something went wrong']);
        }
    }

    /* Function for view list of Testimonial */
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            foreach ($data as $value) {
                ...
                $row['category_name'] = ucfirst($value->category_name);
        ...
        $data = ['title' => ucfirst('Occupations Management'), 'page' => $this->page];
    ...
    /* Function for view Occupations deatils */

    public function view($id)
    {
        $data = Testimonial::where('id', $id)->first();
        if (isset($data)) {
            $result = ['title' => ucwords('Occupations Details'), 'page' => $this->page, 'data' => $data];
    ...
    {     
        ...
        if ($data->save()) {
            return response()->json(['status' => true, 'message' => 'Occupations has been '.$status.' succesfully']);
        } else {
            return response()->json(['status' => false, 'message' => 'Something went wrong']);
        }
    }
    ...
    {     
        ...
        if ($data->save()) {
            return response()->json(['status' => true, 'message' => 'Occupations has been deleted succesfully']);
        } else {
            return response()->json(['status' => false, 'message' => 'Something went wrong']);
        }
    }
