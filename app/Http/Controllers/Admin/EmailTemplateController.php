...
class EmailTemplateController extends Controller
{
    ...
    public function __construct(Request $request)
    {
        ...
        $this->sortableColumns = ['id', 'title', 'subject', 'status', 'updated_at'];
    ...
    /* Function for open update popup */
    ...
    public function manage(Request $request)
    {
        ...
        if ($data->save()) {
            return response()->json(['status' => true, 'message' => 'Email template has been update succesfully']);
        } else {
    ...
    /* Function for open view details popup */
    ...
    {     
        ...
        if ($data->save()) {
            return response()->json(['status' => true, 'message' => 'Email template has been '.$status.' succesfully']);
        } else {
            return response()->json(['status' => false, 'message' => 'Something went wrong']);
        }
    }
