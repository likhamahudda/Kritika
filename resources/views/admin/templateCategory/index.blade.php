...
<div class="d-flex justify-content-between">
    <h5 class="page_heading">{{__('Education List')}} </h5>
    <button type="button" class="btn btn-outline-primary rounded-0 model_open" url="{{route('templateCategory.form')}}"> <i class="bx bxs-plus-square"> </i> {{__('Add Education')}} </button>
</div>
<hr class="page_row">
<div class="card">
    <div class="card-body">
