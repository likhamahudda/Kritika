...
<h5 class="page_heading">{{__('Districts List')}}  </h5>
<button type="button" class="btn btn-outline-primary rounded-0 model_open" url="{{route('districts.form')}}"> <i class="bx bxs-plus-square"> </i> {{__('Add Districts')}} </button>
</div>
<hr class="page_row">
<div class="card">
    <div class="card-body">
