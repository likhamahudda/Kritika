            ...
            <div class="row">
                <div class="col-md-3 row"> 
                     ...
                     <label for="nameBackdrop" class="form-label">{{__('Name')}}* &emsp;
                        {{ Form::text('member_name[]',$data_f['data_f1']->count ?? '' ,['class' =>'form-control name_count', 'placeholder' =>'Name',  'required' => true]) }}
                    </div>
                </div>
                ...
                <div class="col-md-3 row">
                    <label for="nameBackdrop" class="form-label">{{__('D.O.B')}}* &emsp;
                     <div class="col-md-12 mb-3">
                        {{ Form::text('dob[]',$data_f['data_f3']->count ?? '' ,['class' =>'form-control select_dob','id' =>'dob_date', 'placeholder' =>'D.O.B',  'required' => true]) }}
                    </div>
                </div>
                ...
                <div class="col-md-3 row">
                    <label for="nameBackdrop" class="form-label">{{__('Age(Years)')}}* &emsp;
                     <div class="col-md-12 mb-3">
                        {{ Form::text('age[]',$data_f['data_f3']->count ?? '' ,['class' =>'form-control dob_age', 'placeholder' =>'Age',   'required' => true]) }}
                    </div>
                </div>
...
$(function() {
  $(".select_dob").datepicker({
    ...
    onSelect: function(dateText, inst) {
      ...
      if (age > 0) {
        $(this).closest('.col-md-3').next('.col-md-3').find(".dob_age").val(age);
      } else {
        $(this).closest('.col-md-3').next('.col-md-3').find(".dob_age").val("0");
      }
    }
  });
});
...
$(".dob_age").on("change", function() {
  ...
  $(this).closest('.col-md-3').prev('.col-md-3').find(".select_dob").datepicker("setDate", birthDate);
});
