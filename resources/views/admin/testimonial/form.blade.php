...
{{ Form::open(['url' => route('testimonial.manage'), 'class' => 'form_submit_testimonial', 'method'=>'post', 'files' => 'yes']) }}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-6 mb-3 row">
                    <label for="nameBackdrop" class="form-label">{{__('Job Type')}}* &emsp;
                    
                     {{ Form::select('category_name',array('Govt'=>'Govt','Private'=>'Private','Business'=>'Business'),$data->category_name ?? '',['class' =>'form-control', 'placeholder' =>'Select Job Type', 'required' => true]) }}
