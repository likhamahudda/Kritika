...
{{ Form::open(['url' => route('states.manage'), 'class' => 'form_submit_testimonial', 'method'=>'post', 'files' => 'yes']) }}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('States Name')}}*</label>
                    {{ Form::text('states_name',$data->name ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter States Name', 'required' => true]) }}
                </div>


                <div class="col-md-6 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('States Code')}}*</label>
                    {{ Form::text('states_code',$data->code ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter States Name', 'required' => true]) }}
                </div>
