...
<h5 class="page_heading">{{__('Village List')}}  </h5>
<button type="button" class="btn btn-outline-primary rounded-0 model_open" url="{{route('village.form')}}"> <i class="bx bxs-plus-square"> </i> {{__('Add Village')}} </button>
</div>
<hr class="page_row">
<div class="card">
    <div class="card-body">
            ...
            <table id="data_table" class="display" cellspacing="0" width="100%" class="table-responsive">
                <thead>
                    <tr>
                        ...
                        <th> {{__('Panchayat Name')}} </th>
                        <th> {{__('Tehsil Name')}} </th>
