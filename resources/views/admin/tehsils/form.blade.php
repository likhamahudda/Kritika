...
{{ Form::open(['url' => route('tehsils.manage'), 'class' => 'form_submit_testimonial', 'method'=>'post', 'files' => 'yes']) }}
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    {{ Form::text('tehsils_name',$data->name ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter Tehsils Name', 'required' => true]) }}
                </div>
