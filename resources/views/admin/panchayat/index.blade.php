...
<h5 class="page_heading">{{__('Panchayat List')}}  </h5>
<button type="button" class="btn btn-outline-primary rounded-0 model_open" url="{{route('panchayat.form')}}"> <i class="bx bxs-plus-square"> </i> {{__('Add Panchayat')}} </button>
</div>
<hr class="page_row">
<div class="card">
    <div class="card-body">
