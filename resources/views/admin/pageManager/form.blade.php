...
{{ Form::open(['url' => route('pageManager.manage'), 'class' => 'form_submit_email', 'method'=>'post', 'files' => 'yes']) }}
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Page Name')}}*</label>
                    {{ Form::text('page_name',$data->page_name ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter page name', 'required' => true]) }}
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Meta Keyword')}}</label>
                    {{ Form::text('meta_keyword',$data->meta_keyword ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter meta keywords']) }}
                </div>

                <div class="col-md-6 mb-3">
                    <label for="nameBackdrop" class="form-label">{{__('Meta Description')}}</label>
                    {{ Form::textarea('meta_description',$data->meta_description ?? '' ,['class' =>'form-control', 'placeholder' =>'Enter meta description', 'rows' => '2']) }}
                </div>
            </div>
        </div>
