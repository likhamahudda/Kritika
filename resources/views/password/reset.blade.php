          ...
          <div class="login-logo" style=" text-align: center; ">
           ...
           {{ Form::open(['url' => route('password.update'), 'class' => 'form_submit', 'id'=>'formAuthentication' , 'method'=>'Post']) }}
              <div class="form-group">
                ...
                {{ Form::password('password',['class' =>'form-control', 'id'=>'password', 'placeholder' =>'Enter Password', 'required'=>'true' ]) }}

              </div>
              <div class="form-group">
                <label>Confirm Password</label>
                {{ Form::password('confirm_password',['class' =>'form-control', 'placeholder' =>'Enter Confirm Password', 'required'=>'true' ]) }}
               </div>
             
              <div class="form-group">
              <button class="btn btn-blue w-100 mt-4" type="submit"> Reset Password </button> 
